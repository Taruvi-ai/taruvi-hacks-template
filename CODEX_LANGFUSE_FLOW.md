# Codex Langfuse Observability Flow
...
```text
PreToolUse    -> .codex/hooks/langfuse_codex_hook.py
PostToolUse   -> .codex/hooks/langfuse_codex_hook.py
Stop          -> .codex/hooks/langfuse_codex_hook.py
SessionStart  -> .codex/hooks/sync_codex_prompts_to_langfuse.py
```

## Session Start And Prompt Sync

At session start, `.codex/hooks/sync_codex_prompts_to_langfuse.py` runs.
...
The prompt is redacted, truncated to a preview, and sent to Langfuse as:
